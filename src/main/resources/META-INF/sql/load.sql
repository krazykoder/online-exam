insert into product values (1, 'MacBook Pro 13inch Retina Display', 200.00, 'item 1', 3, current_timestamp, current_timestamp);
insert into product values (2, 'iPhone 5s 64G', 50.00, 'item 2', 1, current_timestamp, current_timestamp);
...
insert into orderLine values (1, 1, 1, 1, 200.00, current_timestamp, current_timestamp);
insert into orderLine values (1, 2, 2, 2, 100.00, current_timestamp, current_timestamp);
